...
Nodes 2,100 206
Cores 50,400 6,592
Spark | 5Hadoop record Spark record
...
spark_install("2.3")
Prerequisites | 17You can display all of the versions of Spark that are available for installation by run‐
ning the following:
...
18 | Chapter 2: Getting Startedlibrary(sparklyr)
...
# … with more rows
Using Spark | 19Congrats! You have successfully connected and loaded your first dataset into Spark.
...
20 | Chapter 2: Getting StartedFigure 2-2. The Storage tab on the Apache Spark web interface
...
Using Spark | 21Figure 2-4. The Environment tab on the Apache Spark web interface
...
22 | Chapter 2: Getting Startedlibrary(dplyr)
count(cars)
# Source: spark<?> [?? x 1]
n
<dbl>
...
24 | Chapter 2: Getting StartedData
...
26 | Chapter 2: Getting Startedstream <- stream_read_csv(sc, "input/") %>%
select(mpg, cyl, disp) %>%
...
Using Spark | 27spark_log(sc, filter = "sparklyr")
...
28 | Chapter 2: Getting StartedFigure 2-7. RStudio New Spark Connection dialog

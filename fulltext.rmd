...
As a unified platform, Spark is expected to support many cluster technologies and
...
not handling big data, but there are still benefits from using tools designed for big

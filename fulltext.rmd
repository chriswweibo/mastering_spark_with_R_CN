...
![Figure A-1. The R Project for Statistical Computing](figures/A_2.png)
...
`regr_sxy(independent, dependent)`|Equivalent to regr_count(independent, dependent) * 
`covar_pop(independent, dependent) regr_syy(independent, dependent)`|Equivalent to regr_count(independent, dependent) * var_pop(independent).

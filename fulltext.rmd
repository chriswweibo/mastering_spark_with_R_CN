...
![图3-4. dplyr writes SQL in Spark](figures/3_4.png)

为了边学边练，本章后边的代码使用简单的练习，可以子啊本地SparkTo practice as you learn, the rest of this chapter’s code uses a single exercise that runs
...
![图3-5. Import data to Spark not R](figures/3_5.png)

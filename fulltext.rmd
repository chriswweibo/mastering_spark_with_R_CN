...
select the Spark connection, which opens the dialog shown in 图2-7. You can
...
nections tab, as shown in 图2-8. This is a useful way to track your existing data‐
